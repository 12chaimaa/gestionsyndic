...
namespace gestionsyndic.web.Controllers
{
    public class NotificationsController : Controller
    {
        ...
        public NotificationsController(GestionsyndicContext context)
        {
            _context = context;
        }
        ...
        {
            var gestionsyndicContext = _context.Notifications.Include(n => n.Destinataire);
        ...
        public async Task<IActionResult> Create([Bind("Id,Message,DateEnvoi,Lu,DestinataireId")] Notification notification)
        {
            ...
            ViewData["DestinataireId"] = new SelectList(_context.Utilisateurs, "Id", "Id", notification.DestinataireId);
            return View(notification);
        }
